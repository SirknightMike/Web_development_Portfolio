...
using SLD521FA1.Data;
using SLD521FA1.Models;

namespace SLD521FA1.Controllers
{
    public class RegistersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("userName,password,confirmPassword")] Register register)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("userName,password,confirmPassword")] Register register)
        {
        ...
        {
            return _context.Register.Any(e => e.userName == id);
        }
    }
}
